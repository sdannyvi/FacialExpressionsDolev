...
#
# # Zero Shot clip
# clip_path = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/clip/results/clip_base34_zero_shot.csv"
# clip_df = pd.read_csv(clip_path)
# print(f"the columns of clip results are: {clip_df.columns}")
# clip_fig = plot_classification_report(true_classes_column=clip_df['true_label'], pred_classes_column=clip_df['predictions'])
# save_clip_to = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/clip/clip_zero_shot.html"
# clip_fig.write_html(save_clip_to)
# clip_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/clip/clip_zero_shot.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"Clip- zero shot": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/clip/clip_zero_shot.png")})
#
# wandb.init(project="Zero-Shot- CLIP and Llava", name="LlaVa",
#             notes="Zero-Shot LlaVa",
#             tags=["Llava", "Zero shot"])
#
#
# # Zero Shot llava
# Lava_zero_path = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/results/llava_zero_shot_34b.csv"
# Lava_zero_df = pd.read_csv(Lava_zero_path)
#
# # check values
# classes_list = Lava_zero_df['true_label'].unique().tolist()
# print(f"the columns in llava zero shot: {Lava_zero_df.columns}")
# print(f"llava zero shot, the number of classes in classes list is: {len(classes_list)} and the list is: \n {classes_list}")
# classes_list = Lava_zero_df['predictions'].unique().tolist()
# print(f"llava zero shot, the number of classes in predictions: {len(classes_list)} and the list is: \n {classes_list}")
#
#
#
# llava_zero_fig = plot_classification_report(true_classes_column=Lava_zero_df['true_label'], pred_classes_column=Lava_zero_df['predictions'])
# save_llava_zero_to = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_zero_shot_res.html"
# llava_zero_fig.write_html(save_llava_zero_to)
# llava_zero_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_zero_shot_res.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"LlaVa (34b)- zero shot": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_zero_shot_res.png")})
#
#
# wandb.init(project="RAG- Llava (Retriever CLIP)", name="LlaVa (0.05)",
#             notes="RAG with LlaVa where CLIP is the retriever.",
#             tags=["Llava", "rag"])
#
# # rag llava 0.05
# # classification report
# llava_rag_path_05 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/results/llava_rag_0.05_34b.csv"
# Lava_rag_05 = pd.read_csv(llava_rag_path_05)
#
# # check the values
# classes_list = Lava_rag_05['true_label'].unique().tolist()
# print(f"the columns in llava rag 0.05 are : {Lava_rag_05.columns}")
# print(f"llava rag, the number of classes in classes list is: {len(classes_list)} and the list is: \n {classes_list}")
# classes_list = Lava_rag_05['predictions'].unique().tolist()
# print(f"llava rag, the number of classes in predictions: {len(classes_list)} and the list is: \n {classes_list}")
#
# # how many values of anger and angry are there
# print(f"before change: \n count of angry: {Lava_rag_05['predictions'].eq('angry').sum()} \n "
#       f"count of anger: {Lava_rag_05['predictions'].eq('anger').sum()}")
# # change anger to angry
# Lava_rag_05['predictions'] = Lava_rag_05['predictions'].replace("anger", "angry")
# # print how many values there are of angry
# print(f"after the change:\n count of angry: {Lava_rag_05['predictions'].eq('angry').sum()}")
#
# Lava_rag_05_fig = plot_classification_report(true_classes_column=Lava_rag_05['true_label'], pred_classes_column=Lava_rag_05['predictions'])
# save_llava_rag05 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_05.html"
# Lava_rag_05_fig.write_html(save_llava_rag05)
# Lava_rag_05_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_05.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"LlaVa (34b)- RAG 5%": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_05.png")})
#
#
# # estimating the retriever on 5%
# kb_path_05 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/kb_sets/kb_0.05_rag.csv"
# retriever_clip_05_fig = f1_at_k(res_df_path=llava_rag_path_05, kb_path=kb_path_05, k=3)
# retriever_clip_05_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/retriever_estimation_05.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"Retriever (CLIP) estimation (5%)": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/retriever_estimation_05.png")})
#
#
# wandb.init(project="RAG- Llava (Retriever CLIP)", name="LlaVa (0.1)",
#             notes="RAG with LlaVa where CLIP is the retriever.",
#             tags=["Llava", "rag"])
#
# # rag llava 0.1
# # classification report
# llava_rag_path_10 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/results/llava_rag_0.1_34b.csv"
# Lava_rag_10 = pd.read_csv(llava_rag_path_10)
#
# # check values
# classes_list = Lava_rag_10['true_label'].unique().tolist()
# print(f"the columns in llava rag 0.05 are : {Lava_rag_10.columns}")
# print(f"llava rag 10, the number of classes in classes list is: {len(classes_list)} and the list is: \n {classes_list}")
# classes_list = Lava_rag_10['predictions'].unique().tolist()
# print(f"llava rag 10, the number of classes in predictions: {len(classes_list)} and the list is: \n {classes_list}")
#
# # how many values of anger and angry are there
# print(f"before change: \n count of angry: {Lava_rag_10['predictions'].eq('angry').sum()} \n "
#       f"count of anger: {Lava_rag_10['predictions'].eq('anger').sum()}")
# # change anger to angry
# Lava_rag_10['predictions'] = Lava_rag_10['predictions'].replace("anger", "angry")
# # print how many values there are of angry
# print(f"after the change:\n count of angry: {Lava_rag_10['predictions'].eq('angry').sum()}")
#
# Lava_rag_10_fig = plot_classification_report(true_classes_column=Lava_rag_10['true_label'], pred_classes_column=Lava_rag_10['predictions'])
# save_llava_rag10 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_10.html"
# Lava_rag_10_fig.write_html(save_llava_rag10)
# Lava_rag_10_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_10.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"LlaVa (34b)- RAG 10%": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/llava_rag_10.png")})
#
# # estimating the retriever on 10%
# kb_path_10 = "/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/kb_sets/kb_0.1_rag.csv"
# retriever_clip_10_fig = f1_at_k(res_df_path=llava_rag_path_10, kb_path=kb_path_10, k=3)
# retriever_clip_10_fig.write_image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/retriever_estimation_10.png",
#                  format="png", width=1500, height=750, scale=6)
# wandb.log({"Retriever (CLIP) estimation (10%)": wandb.Image("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/LLaVa/llava_rag/retriever_estimation_10.png")})
#
