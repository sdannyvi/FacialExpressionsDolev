...
#
#  Run with:
#      mkdir -p experiments/oracle/runs/rules_direct_zs_rag12
#      sbatch experiments/oracle/runs/rules_direct_zs_rag12/rules_direct_zs_rag12_job.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/oracle/runs/rules_direct_zs_rag12/%x_%j.log
...
EXP_GROUP="oracle/runs/rules_direct_zs_rag12"
