...
#
#  Run with:
#      mkdir -p experiments/benchmarks/runs/radboud
#      sbatch experiments/benchmarks/runs/radboud/radboud_full_data_zs_rag1_rag2.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=radboud_full_data_zs_rag1_rag2
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/benchmarks/runs/radboud/%x_%j.log
...
EXP_GROUP="benchmarks/runs/radboud"
...
PIPELINE_ARGS=(
  # the full Radboud test set (14 identities, disjoint from train); the gate sends samples with
