...
#
#  Run with:
#      mkdir -p experiments/benchmarks/runs/ferplus
#      sbatch experiments/benchmarks/runs/ferplus/ferplus_full_peivate_test_zs_rag1_rag2.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=ferplus_full_private_test_zs_rag1_rag2
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/benchmarks/runs/ferplus/%x_%j.log
...
EXP_GROUP="benchmarks/runs/ferplus"
...
PIPELINE_ARGS=(
  ...
  # the FER+ training set (50% vote threshold) as the knowledge base
