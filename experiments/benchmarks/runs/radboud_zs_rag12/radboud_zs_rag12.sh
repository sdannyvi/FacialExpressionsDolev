...
#
#  Run with:
#      mkdir -p experiments/benchmarks/runs/radboud_zs_rag12
#      sbatch experiments/benchmarks/runs/radboud_zs_rag12/radboud_zs_rag12.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=radboud_zs_rag12
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/benchmarks/runs/radboud_zs_rag12/%x_%j.log
...
EXP_GROUP="benchmarks/runs/radboud_zs_rag12"
