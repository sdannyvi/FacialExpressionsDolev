...
#      sbatch zeroshot_qwen_3_32b_job.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=zero_shot_qwen_3_32b_instruct
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/generator_comparison/runs/qwen_3_32b_instruct/%x_%j.log
...
EXP_GROUP="generator_comparison/runs/qwen_3_32b_instruct"
...
PIPELINE_ARGS=(
  ...
  --generator_id "Qwen/Qwen3-VL-32B-Instruct"
