...
#      sbatch zeroshot_gemma_4_31b_thinking_job.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=zero_shot_gemma_4_31b_thinking
...
PIPELINE_ARGS=(
  ...
  # ON for this run: it is the thinking half of the gemma-4-31B pair. The checkpoint is
  # registered "thinking": "optional", so the flag is accepted and the results csv gets
  # a thinking column.
  --enable_thinking
)
# --------------------------------------------------------- END PER-EXPERIMENT
