...
#      sbatch zeroshot_gemma_3_27b_job.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=zero_shot_gemma_3_27b
...
PIPELINE_ARGS=(
  ...
  # zero_shot.py takes ONLY these four: --test_path, --generator_id, --results_path
  # (added automatically below) and the bare --enable_thinking flag. No knowledge base,
