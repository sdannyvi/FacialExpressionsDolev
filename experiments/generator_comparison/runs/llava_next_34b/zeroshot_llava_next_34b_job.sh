...
#      sbatch zeroshot_llava_next_34b_job.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=zero_shot_llava_next_34b
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/generator_comparison/runs/llava_next_34b/%x_%j.log
...
EXP_GROUP="generator_comparison/runs/llava_next_34b"
