...
#
#  Run with:
#      mkdir -p experiments/gated_framework_comparison/runs/rules_direct_zs_rag1_rag2
#      sbatch experiments/gated_framework_comparison/runs/rules_direct_zs_rag1_rag2/rules_direct_zs_rag1_rag2.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/gated_framework_comparison/runs/rules_direct_zs_rag1_rag2/%x_%j.log
...
EXP_GROUP="gated_framework_comparison/runs/rules_direct_zs_rag1_rag2"
