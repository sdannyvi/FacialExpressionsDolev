...
#
#  Run with:
#      mkdir -p experiments/gated_framework_comparison/runs/aggregator_answer_explain_format
#      sbatch experiments/gated_framework_comparison/runs/aggregator_answer_explain_format/aggregator_answer_explain_format.sh
#
#  TWO THINGS TO SET:
...
#SBATCH --job-name=aggregator_answer_explain_format
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/gated_framework_comparison/runs/aggregator_answer_explain_format/%x_%j.log
...
EXP_GROUP="gated_framework_comparison/runs/aggregator_answer_explain_format"
...
PIPELINE_ARGS=(
  ...
  --framework    aggregator_answer_explain_format
