...
#SBATCH --job-name=clip_only_top2
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/ablation_val_set/runs/clip_only_top2/%x_%j.log
...
EXP_GROUP="ablation_val_set/runs/clip_only_top2"
...
PIPELINE_ARGS=(
  ...
  # Retriever: CLIP large, no LDA (--dim_reduction none). The CLIP checkpoint is the
  # rag.py default; --dim_reduction is not, so this run ablates the LDA projection.
