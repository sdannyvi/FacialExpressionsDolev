...
#SBATCH --job-name=clip_lda_top2
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/ablation_val_set/runs/clip_lda_top2/%x_%j.log
...
EXP_GROUP="ablation_val_set/runs/clip_lda_top2"
