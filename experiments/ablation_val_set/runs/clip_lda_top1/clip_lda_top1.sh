...
#SBATCH --job-name=clip_lda_top1
#SBATCH --output=/truenas/home/sdolev/FacialExpressionsDolev/experiments/ablation_val_set/runs/clip_lda_top1/%x_%j.log
...
EXP_GROUP="ablation_val_set/runs/clip_lda_top1"
...
PIPELINE_ARGS=(
  ...
  # Retriever: CLIP large + LDA. Both are the rag.py defaults, spelled out here
  # so the ablation cell this run belongs to is readable from the script alone.
