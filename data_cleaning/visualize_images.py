...
# cleaned_df = pd.read_csv("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/data/fer+/fer_clean_confidence_0.6.csv")
# fp_plot = random_samples_plot(df=cleaned_df,n=100,title="Images Classified as Faces by RetinaFace (TP and FP)")
# wandb.log({"Face Images": fp_plot})
#
# # load dataset non face images for True Negative and False Negative
# non_face_df = pd.read_csv("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/data/fer+/fer_non_face_confidence_0.6.csv")
# fn_plot = random_samples_plot(df=non_face_df,n=100,title="Images Classified as Non-Faces by RetinaFace (TN and FN)")
# wandb.log({"Non-Face Images": fn_plot})
#
# wandb.finish()
#
#
...
#
# # load dataset to plot False Positive and True Positive
# cleaned_df = pd.read_csv("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/data/fer+/fer_clean_confidence_0.7.csv")
# fp_plot = random_samples_plot(df=cleaned_df,n=100,title="Images Classified as Faces by RetinaFace (TP and FP)")
# wandb.log({"Face Images": fp_plot})
#
# # load dataset non face images for True Negative and False Negative
# non_face_df = pd.read_csv("/gpfs0/bgu-vilenchi/users/sdolev/Thesis/Vision-Language-Models/data/fer+/fer_non_face_confidence_0.7.csv")
# fn_plot = random_samples_plot(df=non_face_df,n=100,title="Images Classified as Non-Faces by RetinaFace (TN and FN)")
# wandb.log({"Non-Face Images": fn_plot})
#
# wandb.finish()
